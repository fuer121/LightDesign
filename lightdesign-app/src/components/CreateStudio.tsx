...
export default function CreateStudio({
  ...
  eyebrow,
  showBack = true,
  className = 'mx-auto max-w-3xl px-6 pb-16 pt-12',
}: CreateStudioProps) {
  ...
  return (
    <div className={className}>
      ...
      {eyebrow ? <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-amber-700">{eyebrow}</p> : null}
      <h1 className="mb-8 text-2xl font-semibold tracking-tight text-zinc-900 text-balance">{title}</h1>
